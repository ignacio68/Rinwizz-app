  ...
  const config = {
    ...
    resolve: {
      ...
      alias: {
        ...
        '@api': resolve(projectRoot, 'app/api'),
        '@assets': resolve(projectRoot, 'app/assets'),
        '@components': resolve(projectRoot, 'app/components'),
        '@fonts': resolve(projectRoot, 'app/fonts'),
        '@locales': resolve(projectRoot, 'app/locales'),
